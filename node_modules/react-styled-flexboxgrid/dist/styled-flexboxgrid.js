(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('prop-types'), require('styled-components'), require('lodash.isinteger')) :
  typeof define === 'function' && define.amd ? define(['exports', 'prop-types', 'styled-components', 'lodash.isinteger'], factory) :
  (global = global || self, factory(global['react-styled-flexboxgrid'] = {}, global.PropTypes, global.styled, global._.isInteger));
}(this, function (exports, PropTypes, styled, isInteger) { 'use strict';
  ...
  var Grid = styled__default.div(_templateObject$1(), function (p) {
    return config(p).outerMargin + 'rem';
  }, function (p) {
    return config(p).outerMargin + 'rem';
  }, function (p) {
    return !p.fluid && styled.css(_templateObject2(), DIMENSION_NAMES.map(function (t) {
