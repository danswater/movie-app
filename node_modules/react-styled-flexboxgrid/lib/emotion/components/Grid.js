...
var Grid = _reactEmotion.default.div(_templateObject(), function (p) {
  return (0, _config.default)(p).outerMargin + 'rem';
}, function (p) {
  return (0, _config.default)(p).outerMargin + 'rem';
}, function (p) {
  return !p.fluid && (0, _reactEmotion.css)(_templateObject2(), _config.DIMENSION_NAMES.map(function (t) {
